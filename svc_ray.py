...
def train_model(config):
    # Create the SVC classifier based on the hyperparameter configuration
...
final_model = SVC(C=best_config["C"], kernel=best_config["kernel"], gamma=best_config["gamma"])
...
results = {
    ...
    "grid_tried": analysis.get_all_configs(),
...
with open("results/svc_ray.json", "w") as f:
...
with open("results/svc_ray_confusion_matrix.txt", "w") as f:
